...
export class Users1609160938267 implements MigrationInterface {
    name = 'Users1609160938267'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `address` (`id` int UNSIGNED NOT NULL AUTO_INCREMENT, `userId` int UNSIGNED NOT NULL, `title` varchar(150) NOT NULL, `ilce` smallint UNSIGNED NOT NULL, `tc` varchar(11) NOT NULL, `phone` varchar(11) NOT NULL, `address` text NOT NULL, `createdAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `updatedAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (`id`)) ENGINE=InnoDB");
