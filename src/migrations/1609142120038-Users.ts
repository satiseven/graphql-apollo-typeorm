...
export class Users1609142120038 implements MigrationInterface {
    name = 'Users1609142120038'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `users` (`id` int UNSIGNED NOT NULL AUTO_INCREMENT, `name` varchar(150) NOT NULL, `email` varchar(150) NOT NULL, `role` enum ('ADMIN', 'EDITOR', 'MODERNATOR', 'COSTUMER', 'READER') NOT NULL, `emailActivated` tinyint NOT NULL DEFAULT 0, `smsActivated` tinyint NOT NULL DEFAULT 0, `createdAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `updatedAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (`id`)) ENGINE=InnoDB");
